...
public:
    void makeDrone(unsigned int ID, PzG::LaczeDoGNUPlota& Lacze);
    void planInitialFlightPath(double flightHeight, double turnAngle, double flightLenght, std::vector<Vector<3>>& pathPoints);
    void deleteFlightPath() const;
